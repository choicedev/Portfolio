...
import { CalendarRange, Building2, Code2, ExternalLink } from 'lucide-react'; // Adicionei o ícone Code2
...
const TimelineItem: React.FC<TimelineItemProps> = ({ experience, position }) => {
  ...
  aria-label={`Link to ${experience.title}`}
>
  <span className="flex items-center gap-x-2 text-blue-400 hover:text-blue-500 transition-colors duration-200">
    <Building2 size={16} />
    {experience.company}
